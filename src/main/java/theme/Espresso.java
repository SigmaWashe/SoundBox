...
public class Espresso {
    // Backgrounds
    public static final Color ESPRESSO_BG = new Color(225, 210, 190); // Iced coffee cream
    public static final Color CARD_BG        = new Color(245, 235, 220); // Whipped cream

    // Text
    public static final Color TEXT_PRIMARY   = new Color(80, 55, 40);    // Coffee brown
    public static final Color TEXT_SECONDARY = new Color(120, 90, 70);   // Milk coffee

    // Accents
    public static final Color YOUTUBE = new Color(220, 70, 70);   // Strawberry syrup red
    public static final Color SPOTIFY = new Color(95, 185, 130);  // Mint green

    // Interaction
    public static final Color HOVER = new Color(210, 185, 160);   // Caramel drizzle
    ...
    public Espresso(){
        ...
        UIManager.put("Panel.background", ESPRESSO_BG);
        UIManager.put("RootPane.background", ESPRESSO_BG);
        ...
        UIManager.put("Button.background", ESPRESSO_BG);
        UIManager.put("Button.foreground", TEXT_PRIMARY);
        UIManager.put("ToggleButton.background", ESPRESSO_BG);
        UIManager.put("ToggleButton.foreground", TEXT_PRIMARY);

        // --- ComboBox Styling ---
        UIManager.put("ComboBox.font", mainFont);
        UIManager.put("ComboBox.background", ESPRESSO_BG);
        ...
        UIManager.put("TableHeader.background", ESPRESSO_BG);
        ...
        UIManager.put("ToolBar.background", ESPRESSO_BG);
        ...
        // --- File Chooser ---
        UIManager.put("FileChooser.background", ESPRESSO_BG);
    }

    ///=================================================== MAIN PANEL ==================================================
    public void mainPanel(JPanel mainPanel){
        mainPanel.setBackground(ESPRESSO_BG);
    }
    ...
    public void youtubeTab(JPanel youtubeTab){
        youtubeTab.setBackground(ESPRESSO_BG);
    }
    public void youtubeInputCard(JPanel youtubeInputCard, JLabel yt_urlLbl, JTextField yt_urlFld, JLabel yt_OutputDirLbl,
        ...
        yt_BrowseBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/browse.png")));
    ...
    public void youtubeControlCard(JPanel youtubeControlCard, JButton yt_DownloadBtn, JButton yt_CancelBtn,
        ...
        youtubeControlCard.setBackground(ESPRESSO_BG);
        styleButton(yt_DownloadBtn, true, YOUTUBE);
        yt_DownloadBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/download.png")));
        styleButton(yt_CancelBtn, true, TEXT_SECONDARY);
        yt_CancelBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/downloadCancel.png")));
    ...
    public void spotifyTab(JPanel spotifyTab){
        spotifyTab.setBackground(ESPRESSO_BG);
    }
    public void spotifyInputCard(JPanel spotifyInputCard, JLabel spotify_urlLbl, JTextField spotify_urlFld, JLabel spotify_OutputDirLbl,
        ...
        spotify_BrowseBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/browse.png")));
    ...
    public void spotifyControlCard(JPanel spotifyControlCard, JButton spotify_DownloadBtn, JButton spotify_CancelBtn,
        ...
        spotifyControlCard.setBackground(ESPRESSO_BG);
        styleButton(spotify_DownloadBtn, true, SPOTIFY);
        spotify_DownloadBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/download.png")));
        styleButton(spotify_CancelBtn, true, TEXT_SECONDARY);
        spotify_CancelBtn.setIcon(new ImageIcon(getClass().getResource("/espressoTheme/downloadCancel.png")));
    ...
    public void settingsTab(JPanel settingsTab){
        settingsTab.setBackground(ESPRESSO_BG);
    }
    public void settingsScrollPane(JScrollPane settingsScrollPane){
        settingsScrollPane.getViewport().setBackground(ESPRESSO_BG);
    ...
    public void logPanel(JPanel logPanel, JLabel logLbl, JScrollPane scrollPane, JTextArea logArea){
        ...
        logArea.setBackground(ESPRESSO_BG);
    ...
    private void styleTextField(JTextField field) {
        ...
        field.setBackground(ESPRESSO_BG);
    ...
    private JButton styleButton(JButton button, boolean isPrimary, Color primaryColor) {
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (button.isEnabled()) {
                    button.setBackground(ESPRESSO_BG);
                }
            }
